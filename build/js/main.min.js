...
var _coach = require("./modules/slide/coach");
var _feedback = require("./modules/slide/feedback");
var _gym = require("./modules/gym");
...
},{"./modules/form-validate/form":4,"./modules/gym":10,"./modules/init-accordion":11,"./modules/init-tabs":12,"./modules/modals/init-modals":13,"./modules/slide/coach":15,"./modules/slide/feedback":16,"./utils/ios-vh-fix":20}],2:[function(require,module,exports){
"use strict";
...
var button = document.querySelector('.gym-play');
var shadow = document.querySelector('.gym__shadow');
var closest = video.closest('[data-validate="video"]');
function handler() {
  if (closest) {
    if (video.paused) {
      video.play();
...
var clickButton = button.addEventListener('click', handler);
...
},{"./tabs":17}],13:[function(require,module,exports){
"use strict";
...
var swiper = new Swiper('.coach__swiper', {
  cssMode: true,
  loop: true,
  slidesPerView: 1,
  navigation: {
...
var initSwiper = new Swiper('.feedback__swiper', {
  cssMode: true,
  slidesPerView: 1,
  navigation: {
